...
<body>
    ...
    <div class="container">
        ...
        <div class="btn-container">
            <button type="button" onclick="sortByDate('desc')" class="newest-date-btn">Sort by Date (Newest
                First)</button>
            <button type="button" onclick="sortByDate('asc')" class="oldest-date-btn">Sort by Date (Oldest
                First)</button>
        </div>
